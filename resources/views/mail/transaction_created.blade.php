...
<head>
  ...
  <![endif]-->
    <title>Notifikasi Transaksi Baru!</title>
    <link
...
<body
    ...
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Notifikasi Transaksi Baru!</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Kami ingin memberitahu Anda bahwa Transaksi anda berhasil dibuat pada {{ now() }} WIB.
                                            </p>
                                            <hr style="border-top:dashed 1px">
                                            <b
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                Invoice
                                            </b>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                <a href="{{ route('view_transaction', ['invoice' => $result['invoice']]) }}">#{{ $result['invoice'] }}</a>
                                            </p>
                                            <b
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                Katalog
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                Rp. {{ number_format($result['package_price'],0,',','.') }}
                                            </p>
                                            <b
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                Keterangan
