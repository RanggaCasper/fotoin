...
<body
    ...
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Notifikasi Pembayaran!</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Kami ingin memberitahu Anda bahwa Pembayaran anda berhasil diterima pada {{ now() }} WIB.
                                            </p>
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                <a href="{{ route('view_transaction', ['invoice' => $transaction['invoice']]) }}">#{{ $transaction['invoice'] }}</a>
                                            </p>
                                            <b
                                                style="font-family: 'Montserrat', sans-serif; font-size: 12px; mso-line-height-rule: exactly; margin: 0;">
                                                Channel Pembayaran
